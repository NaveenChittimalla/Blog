...
ASP.NET Core is a cross-platform, open-source framwework for creating modern cloud-enabled **web applications, web apis, and IoT apps**, that run on **.NET** application runtime.

ASP.NET Core is a redesign of legacy ASP.NET 4.X framework, including architectual changes that made it leaner, more modular framework with improved performance and memory management.
